...
```{r}
#Covariate: Substrate Temperature Data 
...
cov_mu <- mean(sub_data$substrate_temp)
sub_data$cov= sub_data$substrate_temp - cov_mu
```
...
```
```{r}
cov_ci <- covariate_ci(sq0step_cov, 7171, design = design, n = 500)
